...
describe('Directives', () => {
  it('should define a directive', () => {
    const fn = (builder: any, value: number) => ({ ...builder, value });
  ...
  it('should define and use a directive', () => {
    defineDirective('addFive', (builder: any, num: number) => {
  ...
  it('should allow directives to modify builder', () => {
    defineDirective('setDuration', (builder: any, duration: number) => {
  ...
  it('should handle multiple directives', () => {
    defineDirective('toUpper', (str: string) => str.toUpperCase());
    defineDirective('toLower', (str: string) => str.toLowerCase());
